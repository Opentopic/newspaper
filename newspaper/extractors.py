...
class ContentExtractor(object):
    ...
    def get_title(self, article_url, doc):
        ...
        if not used_delimeter and '-' in title_text and \
                self.check_if_host_in_title(article_url, title_text, DASH_SPLITTER):
            title_text = self.split_title(title_text, DASH_SPLITTER,
                                          title_text_h1)
            used_delimeter = True

        # # split title with _
        # if not used_delimeter and '_' in title_text and \
        #        self.check_if_host_in_title(article_url, title_text, UNDERSCORE_SPLITTER):
        ...
        # # split title with /
        # if not used_delimeter and '/' in title_text and \
        #        self.check_if_host_in_title(article_url, title_text, SLASH_SPLITTER):
        ...
        # split title with :
        if not used_delimeter and ':' in title_text and \
            self.check_if_host_in_title(article_url, title_text, COLON_SPLITTER):
    ...
    def get_favicon(self, article_url, doc):
        ...
        if meta:
            ...
            return urljoin(article_url, favicon)
        return ''
